...
public class DependencyVersionWriter {

    private static final Logger LOGGER = Logger.getInstance(DependencyVersionWriter.class);
    ...
    private static void performUpdate(@NotNull Dependency dependency,
                                      @NotNull String newVersion) {
