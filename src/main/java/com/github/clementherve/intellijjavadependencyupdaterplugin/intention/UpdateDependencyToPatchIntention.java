...
public class UpdateDependencyToPatchIntention extends PsiElementBaseIntentionAction implements IntentionAction {
    ...
    public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement element)
        ...
        VersionCandidate candidate = findPatchUpdate(project, dependency);
        if (candidate == null) {
            return;
        }
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement element) {
        ...
        return findPatchUpdate(project, dependency) != null;
    }
    ...
    private VersionCandidate findPatchUpdate(@NotNull Project project, @NotNull DependencyInfo dependency) {
        ...
        return VersionUpdateType.findLatestByType(currentVersion, candidates, VersionUpdateType.UpdateType.PATCH);
    }
}
