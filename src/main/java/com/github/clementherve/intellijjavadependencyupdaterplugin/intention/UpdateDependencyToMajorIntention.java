 ...
 */
public class UpdateDependencyToMajorIntention extends PsiElementBaseIntentionAction implements IntentionAction {
    ...
    public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement element)
        ...
        VersionCandidate candidate = findMajorUpdate(project, dependency);
        if (candidate == null) {
            return;
        }
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement element) {
        ...
        return findMajorUpdate(project, dependency) != null;
    }
    ...
    private VersionCandidate findMajorUpdate(@NotNull Project project, @NotNull DependencyInfo dependency) {
        ...
        return VersionUpdateType.findLatestByType(currentVersion, candidates, VersionUpdateType.UpdateType.MAJOR);
    }
}
